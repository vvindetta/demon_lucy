...
from lucy_notes_manager.modules.git.worker import build_patch_packet, commit_dirty_tree
from lucy_notes_manager.modules.kdeconnect_sync.config import KDECONNECT_SYNC_TEMPLATE
from lucy_notes_manager.modules.kdeconnect_sync.queue import (
    ensure_queue_excluded_in_repo,
    is_queue_internal_path,
    outgoing_pc_to_phone_dir,
)
from lucy_notes_manager.modules.kdeconnect_sync.transport import (
