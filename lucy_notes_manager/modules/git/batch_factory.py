    ...
    *,
    ...
    return {
        ...
        "debounce_seconds": _value_or_override(
            config_snapshot["git_batch_debounce_seconds"],
        ...
        "backoff_start_seconds": config_snapshot["git_push_backoff_start_seconds"],
        "backoff_max_seconds": config_snapshot["git_push_backoff_max_seconds"],
        "pull_cooldown_min_seconds": _value_or_override(
            config_snapshot["git_pull_cooldown_min_seconds"],
            pull_cooldown_min_seconds_override,
        ),
        "pull_cooldown_max_seconds": config_snapshot["git_pull_cooldown_max_seconds"],
        "max_batch_seconds": _value_or_override(
            config_snapshot["git_batch_max_seconds"],
